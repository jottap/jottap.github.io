...
export const ui = {
    en: {
        ...
        'archive.count': '{count} projects stored in vault',
        ...
        'archive.col.built_with': 'Built With',
        'archive.col.link': 'Link',

        // Contact & Footer
        'connect.whatsapp.title': 'Quick Chat',
        'connect.whatsapp.desc': 'Available for direct tech discussions.',
        'connect.whatsapp.action': 'Chat on WhatsApp',
        'connect.email.title': 'Send Email',
        'connect.email.desc': 'For detailed inquiries and opportunities.',
        'connect.email.action': 'Send Email',
        'contact.fastest_response': 'Fastest response',
        'footer.rights': '© 2025 João Paulo Oliveira. All rights reserved.',

        // Home Sections
        'section.experience.title': 'Experience',
        'section.projects.title': 'Selected Projects',
        'section.projects.filter.industry': 'Industry Projects',
        'section.projects.filter.tools': 'Tools & Tech',
        'section.projects.filter.demos': 'Demos & Jams',
        'section.projects.view_all': 'All Projects',
    },
    pt: {
        // Navegação
        'nav.about': 'Sobre',
        ...
        'skills.core.title': 'Stack Principal',
        ...
        'archive.count': '{count} projetos no cofre',
        ...
        'archive.col.built_with': 'Feito com',
        'archive.col.link': 'Link',
        ...
        'connect.email.action': 'Enviar Email',
        'contact.fastest_response': 'Resposta mais rápida',
        'footer.rights': '© 2025 João Paulo Oliveira. Todos os direitos reservados.',

        // Home Sections
        'section.experience.title': 'Experiência',
        'section.projects.title': 'Projetos Selecionados',
        'section.projects.filter.industry': 'Projetos da Indústria',
        'section.projects.filter.tools': 'Ferramentas & Tech',
        'section.projects.filter.demos': 'Demos & Jams',
        'section.projects.view_all': 'Todos os Projetos',
    },
} as const;
